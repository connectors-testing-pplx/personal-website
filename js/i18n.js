...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'career.title': 'From service to systems.',
      'career.army.period': 'U.S. Army',
      'career.army.role': 'Combat Veteran',
      'career.army.org': 'United States Army',
      'career.army.desc': 'Leadership and decision-making under high-stakes, high-pressure conditions. The discipline, systems thinking, and duty-of-care ethos that now anchor every system I architect.',
      'career.sheriff.period': 'Public service',
      'career.sheriff.role': 'Deputy Sheriff',
      'career.sheriff.org': "County Sheriff's Office",
      'career.sheriff.desc': 'Civilian law enforcement grounded in community trust, accountability, and operational rigor — the foundation of my commitment to verifiable ethical boundaries in technology.',
      'career.current.period': 'Present',
      'career.current.role': 'Neurointelligent-Systems Architect',
      'career.current.org': 'Independent · Defense & Governance',
      'career.current.desc': 'Designing sovereign, offline-autonomous systems — including the patented Ayala neurointelligent claims-preparation engine — for defense, governance, and disability-justice applications.',
      ...
      'credentials.title': 'Recognized work & service.',
      'credentials.patent.h': 'U.S. Patent — Ayala',
      'credentials.patent.d': 'Neurointelligent claims-preparation engine; granted patent protecting the underlying method.',
      'credentials.service.h': 'U.S. Army — Combat Veteran',
      'credentials.service.d': 'Honorable military service with combat deployment; leadership under fire.',
      'credentials.sheriff.h': 'Deputy Sheriff — Civilian Service',
      'credentials.sheriff.d': 'Sworn law-enforcement service; community trust, accountability, and operational discipline.',
      'schedule.kicker': 'Schedule',
      'schedule.title': 'Upcoming appearances.',
      'schedule.olympia.status': 'Cancelled',
      'schedule.olympia.title': 'Mr. Olympia Pro 2026',
      'schedule.olympia.date': '2026 competition season',
      'schedule.olympia.note': "Off the table. A hamstring injury has me in roughly three months of rehab — I'll be back on stage once I'm fully healed. Full update in this week's video.",
      ...
      'contact.print': 'Print / save this résumé',
    ...
    es: {
      ...
      'hero.cta.print': 'Imprimir currículum',
      ...
      'career.kicker': 'Trayectoria',
      'career.title': 'De servicio a sistemas.',
      'career.army.period': 'Ejército',
      'career.army.role': 'Veterano de combate',
      'career.army.org': 'Ejército de los Estados Unidos',
      'career.army.desc': 'Liderazgo y toma de decisiones en condiciones de alta tensión y alto riesgo. La disciplina, el pensamiento sistémico y la ética del deber de cuidado que ahora anclan cada sistema que diseño.',
      'career.sheriff.period': 'Servicio público',
      'career.sheriff.role': 'Alguacil adjunto',
      'career.sheriff.org': 'Oficina del Alguacil del Condado',
      'career.sheriff.desc': 'Aplicación de la ley civil basada en la confianza comunitaria, la responsabilidad y el rigor operativo — la base de mi compromiso con los límites éticos verificables en la tecnología.',
      'career.current.period': 'Presente',
      'career.current.role': 'Arquitecto de sistemas neurointeligentes',
      'career.current.org': 'Independiente · Defensa y Gobernanza',
      'career.current.desc': 'Diseñando sistemas soberanos y autónomos sin conexión — incluido el motor neurointeligente patentado Ayala — para aplicaciones de defensa, gobernanza y justicia de discapacidad.',
      ...
      'credentials.kicker': 'Credenciales',
      'credentials.title': 'Trabajo y servicio reconocidos.',
      'credentials.patent.h': 'Patente EE. UU. — Ayala',
      'credentials.patent.d': 'Motor neurointeligente de preparación de reclamaciones; patente otorgada que protege el método subyacente.',
      'credentials.service.h': 'Ejército de los EE. UU. — Veterano de combate',
      'credentials.service.d': 'Servicio militar honorable con despliegue en combate; liderazgo bajo fuego.',
      'credentials.sheriff.h': 'Alguacil adjunto — Servicio civil',
      'credentials.sheriff.d': 'Servicio de aplicación de la ley; confianza comunitaria, responsabilidad y disciplina operativa.',
      'schedule.kicker': 'Calendario',
      'schedule.title': 'Próximas apariciones.',
      'schedule.olympia.status': 'Cancelado',
      'schedule.olympia.title': 'Mr. Olympia Pro 2026',
      'schedule.olympia.date': 'Temporada de competencias 2026',
      'schedule.olympia.note': 'Fuera de la mesa. Una lesión en el isquiotibial me tiene en aproximadamente tres meses de rehabilitación — volveré al escenario cuando esté completamente recuperado. Actualización completa en el video de esta semana.',
      ...
      'contact.telegram': 'Telegram — t.me/alonsobrx',
      'contact.print': 'Imprimir / guardar este currículum',
